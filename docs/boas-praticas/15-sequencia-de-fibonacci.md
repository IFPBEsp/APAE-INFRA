# 15. Estimativa de esforço (escala de Fibonacci)
...
## 15.1 Significado de cada valor
...
## 15.2 Exemplos de issue por pontuação
...
## 15.3 Onde registrar a pontuação
